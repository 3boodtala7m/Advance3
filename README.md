I did the first thing in the packages so that the process of reading the code would be more organized and flexible The first package for the decorator:
